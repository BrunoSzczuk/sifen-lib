...
public class TgTotSub extends SifenObjectBase {
    ...
    public void setupSOAPElements(SOAPElement DE, TTiDE iTiDE, TgDtipDE gDtipDE, TgOpeCom gOpeCom) throws SOAPException {
		...
		this.dPorcDescTotal = this.dDescTotal.compareTo(BigDecimal.ZERO) <= 0 ? BigDecimal.ZERO : this.dDescTotal.multiply(BigDecimal.valueOf(100))
				.divide(this.dTotOpe.add(this.dDescTotal), 2, RoundingMode.HALF_UP);
